...
register(
    ...
    kwargs={
        ...
        "robot_site_name": "end_effector",
        "target_site_name": "target",
        "target_xyz_range": {"high": [0.3, 0.5, 1.2], "low": [-0.3, 0.1, 0.8]},
    },
)
...
register(
    ...
    kwargs={
        ...
        "target_site_name": "target",
        "target_xyz_range": {"high": [-0.4, 0.5, 0.78], "low": [-0.4, 0.5, 0.78]},
    },
)
...
register(
    ...
    kwargs={
        ...
        "object_site_name": "sugarbox",
        "target_site_name": "target",
        "target_xyz_range": {"high": [0.4, 0.5, 0.78], "low": [-0.4, 0.4, 0.78]},
    },
)
